...
Phase 6B: Person C sees a fixed Agent C introduction, records a voice sample only on the clone arm, then Agent C joins the meeting automatically. Live prompts (approve / edit / reject) arrive in Phase 6C.
